...
const invalidate_url = `https://api.cloudflare.com/client/v4/zones/${zone_id}/purge_cache`;
const max_per_request = 30;
const to_invalidate = readFileSync(process.argv[2], 'utf8')
	.split('\n')
	.filter(Boolean);
const token = process.env['CLOUDFLARE_PURGE_KEY'];
